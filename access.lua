...
local cb_server_name    = ngx.var.ngo_callback_host or ngx.var.host
local cb_uri            = ngx.var.ngo_callback_uri or "/_oauth"
local cb_url            = cb_scheme .. "://" .. cb_server_name .. cb_uri
local redir_server_name = ngx.var.ngo_redirect_host or ngx.var.host
local redirect_url      = cb_scheme .. "://" .. redir_server_name .. ngx.var.request_uri
